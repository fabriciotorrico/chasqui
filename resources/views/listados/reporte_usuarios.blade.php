...
<div class="box-body box-white">
    ...
    <div class="table-responsive" >
		...
		{{-- <td>{{$trabajados}}</td> --}}
			<td>
				<button type="button" class="btn btn-default btn-xs" onclick="verinfo_usuario({{  $usuario->id_usuario }} , 4)" ><i class="fa fa-fw fa-file-text"></i></button>
				<button type="button" class="btn btn-default btn-xs" onclick="verinfo_usuario({{  $usuario->id_usuario }} , 13)" ><i class="fa fa-fw fa-calendar-check-o"></i></button>
				<button type="button" class="btn btn-danger btn-xs" onclick="verinfo_usuario({{  $usuario->id_usuario }} , 2)" ><i class="fa fa-fw fa-user-times"></i></button>
			</td>
		</tr>
	    @endforeach
