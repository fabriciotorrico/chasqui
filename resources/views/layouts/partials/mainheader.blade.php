...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-mini"><b>Chasqui</b></span>
        <div class="row centered  logo-lg">
            <img src="{{asset('/img/chasqui_diseño_blanco.png')}}" style="width:160px;height:40px;" class="centered" alt="User Image"/>
        </div>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                  <a href="#" class="btn btn-default btn-flat">Editar {{ trans('adminlte_lang::message.profile') }}</a>
                                </div>
