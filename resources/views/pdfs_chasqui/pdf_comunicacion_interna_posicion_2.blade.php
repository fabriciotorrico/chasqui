...
<body>
  ...
  <!-- DERIVACION POSICION 1, para generar el espacio en blanco -->
  <table style="width:100%; height:44%; max-height: 100px; border-collapse: collapse; margin: 0 0 1em 0" border=0>
    <tr>
    </tr>
  </table>
  <br>
