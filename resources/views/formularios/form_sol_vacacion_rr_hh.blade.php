        ...
        <div class="col-md-12">
            <div class="row">
                ...
                @endphp
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-4 col-xs-12"><h3 class="box-title"><b>CAS: </b></h3></div><div class="col-md-9 col-sm-8 col-xs-12"><h3 class="box-title">{{$gestion->year}}a {{$gestion->month}}m {{$gestion->day}}d</h3></div>
                    </div>
                </div>
            </div>
        </div>

    <form  action="{{ url('verificar_solicitud') }}"  method="post" id="f_verificar_solicitud" class="formentrada" >
