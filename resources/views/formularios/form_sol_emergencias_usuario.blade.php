                        ...
                        <div class="box box-solid">
                          ...
                          <div class="box-body">
                            ...
                            <div id="external-events">
                              ...
                              <div class="external-event bg-yellow ui-draggable ui-draggable-handle" style="position: relative;">Vacación Autorizada</div>
                              <div class="external-event bg-green ui-draggable ui-draggable-handle" style="position: relative;">Vacación Verificada</div>
                              ...
                              <div class="external-event ui-draggable ui-draggable-handle" style="background-color: #ffb100d1; color: rgb(255, 255, 255); position: relative;">Suspensión Autorizada</div>
                              <div class="external-event ui-draggable ui-draggable-handle" style="background-color: #00de78eb; color: rgb(255, 255, 255); position: relative;">Suspensión Verificada</div>
                            </div>
                          </div>
                          <!-- /.box-body -->
                        </div>
