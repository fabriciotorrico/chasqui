              ...
              <div class="col-sm-9 col-sm-offset-1 myform-cont" >
                 <div class="myform-top">
                    <div class="myform-top-left">
                       ...
                       <h3 class="text-muted">Correspondencia</h3>
                    </div>
                  ...
                  <div class="col-md-12" >
                   ...
                   <div class="myform-bottom">
                      ...
                      @if($accion == "enviar_nueva_correspondencia")
                        <form class="formentrada_usuario" action="{{ url('nueva_correspondencia') }}" method="post">
                      @elseif($accion == "derivar_correspondencia")
                        <form class="formentrada_usuario" action="{{ url('derivar_correspondencia') }}" method="post">
                      @endif
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="id_instruccion" id="id_instruccion" onchange="mostrar_ocultar_instruccion_otra()" required>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="text-muted" id="label_instruccion_otro">Detalle la Instrucción:</label>
                                <input type="text" maxlength="295" name="instruccion_otro" id="instruccion_otro" placeholder="Introduzca la instrucción de la Comunicación Interna (Otro)" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="text-muted ">Referencia:</label>
                                <input type="text" maxlength="295" name="referencia" id="referencia" placeholder="Introduzca la referencia de la Comunicación Interna" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-9">
                            <div class="form-group">
                                <label class="text-muted ">Contenido (cite / descripción):</label>
                                <input type="text" maxlength="500" name="contenido" placeholder="Introduzca el cite y descripción de los documentos que adjunta" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        @elseif($accion == "derivar_correspondencia")
                          <input type="hidden" name="id_derivacion" class="form-control" value="{{ $id_derivacion }}" readonly>
                          <button type="submit" class="bg-blue mybtn" id="finalizar">  <i class="fa fa-share-square-o"></i>Derivar Correspondencia</button>
                        @endif
                    </form>
                  </div>
              </div>
...
<script>
    ...
    $( document ).ready(function() {
      mostrar_ocultar_instruccion_otra();
    ...
    function mostrar_ocultar_instruccion_otra(){
      if (document.getElementById('id_instruccion').value === "999999") {
          $("#instruccion_otro").prop("disabled", false);
          document.getElementById('label_instruccion_otro').style.display = "block";
          document.getElementById('instruccion_otro').style.display = "block";
      } else {
          $("#instruccion_otro").prop("disabled", true);
          document.getElementById('label_instruccion_otro').style.display = "none";
          document.getElementById('instruccion_otro').style.display = "none";
      }
    }
